...
Verified members can choose to delegate their voting power to a delegatee. The Stakers Union uses the [`"with-delegation"`](https://v1.snapshot.box/#/strategy/with-delegation) voting strategy, which allows members to delegate their voting power to a delegatee. Delegators can't take back their voting power from the delegatee.
