...
4. Download the provided audio file and play it on your node.
5. Show live logs of your validator software.

[^1]: Steps 2-4 are required only if proving home operation
