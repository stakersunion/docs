...
2. Minimum of two consecutive missed attestations and no more than ten consecutive missed attestations on at least one validator
3. Only one repeat attempt is allowed if the first attempt fails
...
2. An international newspaper front page or a printout of the front page of a major news website must be included, with the text "Stakers Union" hand-written visibly on it.
