...
After submission of the signed message, prospective members must prove independent operation of their validator. Prospective members will receive a set of dates/times from which they will select one time period to disable attestations. This action proves the validator is under the control of the prospective member.
